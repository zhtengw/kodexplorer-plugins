<html><head>
	...
	<link href="./static/style/common.css?ver=4.40" rel="stylesheet">
	<link href="./static/style/font-awesome/css/font-awesome.css?ver=4.40" rel="stylesheet">
	<title><?php echo $msg_title; ?></title>
	<script type="text/javascript" src="./static/js/lib/jquery-1.8.0.min.js?ver=4.40"></script>
	<style type="text/css">
		body{
